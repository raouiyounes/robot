...
public:
  ...
  bool process (Mat image, uint8_t *I,int32_t* dims,bool replace=false);
...
private:
  ...
  Matrix	       estimateMotion2 (std::vector<Matcher::p_match> p_matched);
...
/////////////////////////////////
  int32_t triangulate(Matrix K, Matrix R, Matrix t, vector<Matcher::p_match> p_matched, vector< vector<Point2d> > &pointsImg, vector<Point3d> &points3D);
  double weight(Matcher::p_match it1, Matcher::p_match it2, Matrix K, Matrix P1, Matrix P2);
  double compute_scale(Matrix R, Matrix t, Matrix K, vector<Matcher::p_match> p_matched, vector<Matcher::p_match> p_p_matched, Matrix p_Tr_delta, double &ll);
/////////////////////////////////
